...
// Perlin Noise function for creating nebula clouds
...
void main() {
    float n = snoise(vec3(vUv * 2.0, u_time * 0.1));
    n = pow(n, 2.5);
    vec3 color = mix(u_color_a, u_color_b, smoothstep(0.0, 1.0, n));
...
const NebulaPlane = () => {
    ...
    const uniforms = useMemo(() => ({
        u_time: { value: 0.0 },
        u_color_a: { value: new THREE.Color("#112C70") }, // --primary
        u_color_b: { value: new THREE.Color("#5B58EB") }, // --secondary
    }), []);
